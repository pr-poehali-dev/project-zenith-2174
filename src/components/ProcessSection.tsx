...
const steps = [
  {
    ...
    description:
      "Вы выбираете интересующий курс и записываетесь на бесплатную консультацию. Мы расскажем о программе, сроках, стоимости и ответим на все вопросы. Поможем определиться, если ещё не уверены.",
    number: "01",
  },
  {
    icon: PaletteIcon,
    ...
    description:
      "Теория + практика в учебных мастерских под руководством опытных инструкторов. Работаете с реальным оборудованием, выполняете задания и нарабатываете уверенные навыки.",
    number: "02",
  },
  {
    icon: Rocket,
    ...
    description:
      "По окончании курса получаете удостоверение и помощь в поиске работы. Наши партнёры-работодатели готовы рассматривать выпускников. Многие находят работу ещё до окончания курса!",
    number: "03",
  },
]
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
            Три шага от записи до трудоустройства. Просто, понятно и без лишних барьеров.
          </p>
        </div>
